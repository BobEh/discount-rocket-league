...
void cGameObject::GetTransform(glm::mat4& transformOut)
{
	transformOut = this->_matWorld;
}

void cGameObject::GetPosition(glm::vec3& positionOut)
{
	glm::vec3 result = glm::vec3(0.0f, 0.0f, 0.0f);
	//this->GetComponent()->GetPosition(result);
	positionOut = result;
}

void cGameObject::SetPosition(glm::vec3 positionIn)
{
...
std::string cGameObject::GetPlaneType()
{
	return this->_planeType;
}

void cGameObject::SetPlaneType(std::string planeType)
{
	this->_planeType = planeType;
}

void cGameObject::SetComponent(nPhysics::iPhysicsComponent* component)
{
	this->_component = component;
}

nPhysics::iPhysicsComponent* cGameObject::GetComponent()
{
...
void cGameObject::SetMassType(int physicsType)
{
...
cSimpleAssimpSkinnedMesh* cGameObject::getSM()
{
	return this->pSM;
}
